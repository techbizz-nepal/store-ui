...
const LoginForm = ({register, errors, handleSubmit, onLoginSubmit, LoginSubmitText, effect, setEffect, disable}) => {
    console.log(errors)
    return (
        <div className={`gap-y-8`} id={`loginFormWrapper`}>
            ...
            <form className={`flex flex-col gap-y-4`}
                ...
                <div className={`flex gap-x-2 items-center`}>
                    <input type="checkbox" name={`remember`} {...register('rememberMe')}  />
                    Remember me
                </div>
