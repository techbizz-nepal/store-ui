...
const ProductDetail = ({productDetail}) => {
    ...
    return (
        <div id={`content`} className={`flex flex-col gap-y-10 items-center`}>
            <div id={`detailAction`}
                 className={`containerDiv flex justify-start gap-x-4`}>
            ...
            <div id={`detailBody`} className={`containerDiv flex justify-start gap-x-4`}>
                <div className={`flex-auto flex-col`}>
                    <div id={`title`} className={`text-md font-light`}>Description</div>
                    <div id={`body`}>Body</div>
                </div>
                <div className={`flex-auto`}>detail</div>
            </div>
        </div>
    )
}
